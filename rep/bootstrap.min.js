...
function(p) {
    ...
    c.prototype.getItemIndex = function(t) {
        return this.$items = t.parent().children(".bootsitem"),
    ...
    c.prototype.to = function(t) {
        var e = this
          , i = this.getItemIndex(this.$active = this.$element.find(".bootsitem.active"));
    ...
    c.prototype.slide = function(t, e) {
        var i = this.$element.find(".bootsitem.active")
